...
def openPreferences():
    ...
    # ***** Preview *****
    previewText = Text(pw, width=48, height=11)
    previewTextContent = prefs.previewText
    previewText.insert(END, previewTextContent)
    previewText.config(state="disabled")
    previewText.grid(row=0, column=3, rowspan=3, columnspan=15, padx=5, pady=5)
...
if __name__ == "__main__":
    ...
    #region Fill Sub-Menus for Mac OS
        ...
        fileMenu.add_command(label="Save As", command=saveFileAs, accelerator="Cmd+^+S")
